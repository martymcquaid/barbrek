...
- **Dev Server URL**: `http://127.0.0.1:5247`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/70955354-a87f-4222-931c-2605d36e6b62/preview`
- **Port**: `5247`
...
4. The dev server is accessible at `http://127.0.0.1:5247`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/70955354-a87f-4222-931c-2605d36e6b62/preview`
